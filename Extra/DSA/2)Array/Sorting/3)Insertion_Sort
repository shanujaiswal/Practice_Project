...
--> It works similarly to how you might sort playing cards in your hands - you take each new card and insert it into its proper position among the already sorted cards.
...
--> Insertion Sort is often used when the data is nearly sorted (where it approaches O(n) time) or when the dataset is small.
--> Some hybrid algorithms like TimSort use Insertion Sort for small subarrays due to its low overhead.
